...
<template>
  <div>
    <UButton
      v-if="!custom"
      class="border border-primary bg-primary min-h-[40px] flex gap-1 items-center justify-center px-3 font-semibold rounded text-white hover:bg-white hover:text-primary transition-colors cursor-pointer"
      @click="handleClick"
    >
